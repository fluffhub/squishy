Module(function M() {
  M.Import("squishy/DOM",function(DOM) {
    ...
    var Color=M.Def(function Color(value) {
    ...
    var Gradient=M.Def(function Gradient() {
      var args = Array.prototype.slice.call(arguments);
      var dir = args.splice(0,1)[0];
      var output="linear-gradient("+dir+", ";
      var steps=[];
      if(args.length%2==0) {
        for(var i=0;i<args.length/2;i++) {
          steps.push(args[i*2]+" "+args[i*2+1])
        }
