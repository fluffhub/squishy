  ...
  var StyleSheet=M.Class(function C() {
    C.Init(function StyleSheet(element,attr,doc) {
      ...
      if(typeof element === "string") {
        //this is a filename
        this.element = this.doc.createElement("link");
    ...
    C.Def(function addStyle(query,rules) {
          ...
          if (rules instanceof Array) {
            ...
            if (rules === undefined) {
              ...
              Object.keys(rules).map(function(k) {
                var values=k.split("__");
                var value="";
                if(values.length>1) {
                  value=values[0]+":"+S.ThemeFormatters[values[1]].get(rules,values[0])+";";
                } else {
                  value=k+":"+rules[k]+";"
                }
                str+=value;
      ...
      this.sheet.insertRule(query+"{"+newrules+"}");
        ...
        if(typeof value==="object") {
          if(value instanceof Array) {
            ...
            if(value.length==1) {
              ...
              var opacity=normalize_opacity(value.pop());
              value=value.map(function(v) { return normalize_chunk(v) })
              return "rgba("+(value+[opacity]).join(",")+")";
            }
          }
    ...
    C.Def(function Theme(obj) {
      var target=this;
      return Watch(obj, function(t,k,v) { 
        target.clear();
        target.init();
      }, {
        getter:function(t,k) {
