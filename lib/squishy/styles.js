Module(function M() {
  ...
  var StyleSheet=M.Class(function C() {
    C.Init(function StyleSheet(element,attr,doc) {
      ...
      if(typeof element === "string") {
        ...
        if(element instanceof Element) {
          ...
          if(element instanceof Function) {
              element.addRule=function() {
                ss.addStyle.apply(ss,arguments);
              }
              element.call(this);
          }
        }
      ...
      Object.defineProperty(this,"sheet",{get:function() { console.debug("getting sheet... "); return this.element.sheet }, writable:false});
    });
    ...
    C.Def(function addStyle(query,rules) {
      ...
      if(typeof rules === "string") {
        this.sheet.addRule(query, rules);
      } else {
