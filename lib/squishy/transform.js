        ...
        M.Import('squishy/svg',function(svg) {
          ...
          var GenericMatrixBox=M.Class(function C() {
            ...
            C.Mixin({
              ...
              min:1,
              max:Infinity, //[0,0],[1,0],[1,1],[0,1]
              orientations:{nw:[-1,-1],ne:[1,-1],se:[1,1],sw:[-1,1]},
              directions:[["top","left"],["width","height"]],
              getstate:function() {
          ...
          var HTMLPositionBox=M.Class(function C() {
            ...
            C.Def(function drawTransform(units) {
              ...
              if(this.size.width===undefined) this.size={width:this.element.offsetWidth,height:this.element.offsetHeight}
              if(this.position.x===undefined) this.position={y:this.element.offsetTop,x:this.element.offsetLeft}
            ...
            C.Mixin({
              enabledrag:function(callback) {
                ...
                if(!this.events||!this.events.dragstart)
                  this.addEvent('dragstart','mousedown touchstart',this.dragstart,this.element,{overwrite:true,passive:true});
          ...
          var Resizable=M.Class(function C() {
            ...
            C.Mixin({
              ...
              doResize:function doResize(state,handle) {
                var re=this;
                ...
                ({nw: function nw(state,handle) {
                  ...
                  re.height=state.height+handle.delta.y;
                ...
                console.debug({state:state,handle:handle,this1:this});
              },
              draghandler:function() {
                var that=this;
                return function(state) {
