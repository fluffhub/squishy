  ...
  if(document) {
    ...
    var Tag=M.Class(function C() {
      ...
      C.Set(function setter(t,k,v) {
        var result, target;
        if (!Object.hasOwnProperty(t,k) || Object.getOwnPropertyDescriptor(t,k).enumerable===true) {
          if(v===null) target=null 
          else if(v.__watched__) target=v;
      ...
      C.Def(function query(str) {
        ...
        elements.forEach(function(element,i) {
          ...
          if(element.hasOwnProperty("Tag")) {
            ...
            function populate(o) {
              element.Tag=o;
              Object.defineProperty(o,"element",{value:element,configurable:true});
              new_elements[i]=o;
              el.query("*")
            }
