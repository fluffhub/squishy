  ...
  if(document) {
    ...
    var Tag=M.Class(function C() {
      C.Init(function Tag() { with(Tag.kwargs({"type":"div","cls":null,"id":null,attrs:null,content:""})) {
        ...
        */
        ...
        element.Tag=this;
        element.setAttribute('data-class', this.constructor.src);
      ...
      C.Def(function get_handler(fun) {
        var that=this,args=[];
      ...
      C.Def(function insert(element,location) {
        ...
        for(var i=0;i<this.elements.length;i++) {
          if(location.__self__===this.elements[i].__self__) {
    ...
    var Frame=M.Class(function C() {
      ...
      C.Init(function Frame() { with(Frame.kwargs({win:window,doc:document,callback:function(){}})) {
        ...
        if(header.length>0) {
          Object.defineProperty(this,"head",{value:new Tag(header[0])});
        }
        else {
          Object.defineProperty(this,"head",{value:new Tag("head")});
          this.parent.add(this.head);
        }

        //series of events to add onmove to the window object

        this.elements={};
        this.window.onresize=function(handle) {
          that.resize();
        };
        this.resize();
      }});
    ...
    Object.defineProperty(M.Self,"root",{
      get:function() {
