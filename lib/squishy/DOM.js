Module(function M() {
  if(document) {
    ...
    var Tag=M.Class(function C() {
      ...
      function identify(v) {
        if (v instanceof Tag  || v instanceof Element) {
          var uid;
      ...
      C.Construct(function(po) {
        po.element.Tag=po;
      });
      C.Set(function setter(t,k,v) {
        var result, target;

        if (k!=="element" && (!Object.hasOwnProperty(t,k) || Object.getOwnPropertyDescriptor(t,k).enumerable===true)) {
    ...
    var XTag=M.Class(function C(){
      ...
      C.Init(function XTag(NS,type,attrs) {
        ...
        } else if (NS instanceof Element) {
          this.xmlns=NS.namespaceURI;
          element = NS;
        }
