Module(function M() {
  M.Import('squishy/DOM',"squishy/request",function(DOM,Req) {
    ...
    var PathDefinition=M.Class(function C(){
      ...
      var findpieces=/([MmLlhsSHcCvVaAzZ])/;
      ...
      C.Def(function parse(d) {
        d=d.trim();
        var pieces=d.split(findpieces);
      ...
      C.Def(function addPoint(c,p) {
        var c=c || "S";
        var i=this.points.length-2;
        this.points.splice(i,0,p);
        this.commands.splice(i,0,c);
      });
