...
var Request=M.Class(function C() {
  C.Def("timeout",0)
    ...
    C.Mixin({
      ...
      setEvents:function() {
        //  this.addEvent("progress", "progress", this.progress, this.request,{overwrite:true});
        this.addEvent("load", "load", this.load, this.request,{overwrite:true});
        this.addEvent("error", "error", this.onerror, this.request,{overwrite:true});
        this.addEvent("abort", "abort", this.abort, this.request,{overwrite:true});
      },
