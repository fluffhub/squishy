    ...
    function(basic,DOM,events) {
      ...
      var Collapsible=M.Class(function C() {
        ...
        C.Init(function Collapsible(name, title,content,callback,handle) {
          ...
          if(handle) {
            ...
            this.button=handle;
            this.addBefore(handle);
            this.button.element.onclick=this.get_handler(this.toggle);
          } else
            this.bar.element.onclick=this.get_handler(this.toggle);
          this.open();
          this.disabled=false;
          if(content)
            this.add(content);
      ...
      var TabSet=M.Class(function C() {
        ...
        C.Def(function addTab(name, title,cls, callback) {
          ...
          tab.element.onclick=this.get_handler(this.change, name);
      ...
      M.Class(function C() {
        ...
        C.Def(function addTab(name,title,pane,cls,callback) {
          ...
          this.callbacks[name]=callback;
          this.tabset.addTab(name,title,cls, this.get_handler(this.change,name));
      ...
      M.Class(function C() {
        ...
        C.Init(function MomentaryButton(title,cls,callback,name) {
          ...
          if(callback) Object.defineProperty(this,'onclick',{
            ...
            value:this.get_handler(callback),
          });
          this.enable();
          this.enableEvents();
          //this.element.onclick=this.get_handler(this.click);
        });
        C.Mixin(events.hasEvents);
