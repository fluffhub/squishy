...
M.Import('/js/MatrixBox.js',function(mb) {
  ...
  var ImageEditor=M.Class(function C() {
    ...
    //  this.Image=image;
      ...
      this.controls.Madd(
        new MomentaryButton('I','',this.get_handler(this.zoomin))
        ,new MomentaryButton('O','',this.get_handler(this.zoomout))
        ,new MomentaryButton('L','',this.get_handler(this.rotateright))
        ,new MomentaryButton('R','',this.get_handler(this.rotateleft)));
