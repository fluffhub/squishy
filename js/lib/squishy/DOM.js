Module(function M() {
	var Tag=M.Class(function C() {
		C.Init(function Tag(type, cls, id, attrs) {
      ...
      Object.defineProperty(this,'element',{
        enumerable:false,value:element,
        writable:true,
      });
      element.Tag=this;
      ...
      Object.defineProperty(this,'init',{
        ...
        writable:true
			...
			//try { this.$e=jQuery(this.element); }
     // catch(e) {}
      try { this.init(); } catch(e) {
        //this subclass didn't define init.  whatever.
      }
		});
  ...
  var LayoutItem=M.Class(function C() {
	...
	M.Class(function C() {
    C.Super(LayoutItem);
		C.Init(function Frame(win,doc,callback) {
