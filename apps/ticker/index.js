Module(function M() {
  M.Import("apps/spoon","squishy/realtime","squishy/basic","squishy/svg","squishy/form","spoon/windowing",function(spoon,rt,basic,svg,form,windowing) {
    M.Index("fake");
      ...
      var Ticker=M.Class(function C() {
        ...
        var TickerMaker=M.Class(function C() {
          ...
          C.Init(function() {
            ...
            this.submit=new form.Submit("y","submit");
            this.form=new form.Form("tickerentry",function() {
